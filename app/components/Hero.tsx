    ...
    <div className='hero animate__animated animate__fadeInRight opacity-0 h-[400px] py-6 mx-auto relative overflow-hidden transition-all duration-300 ease-in-out'>
      <div className='hero-content flex-col lg:flex-row'>
        ...
        <div className='sm:w-[80%]'>
          ...
          <Link
            className='hover:text-lime-400/80 group text-gray-300 transition-all duration-300 ease-in-out font-black absolutes flex items-center absolute bottom-0 right-6'
            href={''}
          >
            More Details
